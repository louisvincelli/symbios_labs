                ...
                <div>
                    ...
                    <div className='w-fit py-1.5 px-2 md:px-5 rounded-full shadow-md flex items-center space-x-3 bg-white'>
                        ...
                        <p className='text-xs sm:text-sm'>
                            We haveupdated our term & condition policy
                        </p>
                    </div>
                    {/* Heading */}
                    <h1 className='text-2xl sm:text-4xl md:text-5xl mt-6 mb-6 font-bold md:leading-12 lg:leading-14'>
                        Exploring the shared evolution of living and artificial intelligence alike. Where living and artificial intelligence evolve in harmony.
                    </h1>
                    {/* Description */}
